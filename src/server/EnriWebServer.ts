    ...
    return {
      ...
      outputSchema: {
        ...
        properties: {
          ...
          screenshot_reason: { type: "string", description: "Razón de captura o omisión: auto_thin_text, forced, analyze_requested, image_target (la URL apuntaba a una imagen y va adjunta inline), auto_rich_text, background_verification, http_error_status, capture_failed, lane_unsupported." },
